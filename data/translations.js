    ...
    projects: {
      ...
      items: [
        { label: "Client Project (Live)", title: "Aleppo Pistazien — Bilingual Café Website",
          ...
          thumb: "img/projects/aleppo-thumb.jpg",
          ...
          action: "Benchmarked local café sites, wrote a structured client brief, then built a fully bilingual DE/AR site — every element mirrored, RTL included — as static HTML/CSS/JS on Cloudflare Pages, with a lightweight built-in product tool the shop manager uses to add and update the assortment themselves — no heavyweight CMS. Ordering deliberately runs through WhatsApp instead of a webshop, because that's where the customers already are. Legal pages, allergen disclosure, and a click-to-load map keep it DSGVO-clean.",
        ...
        { label: "Client Project (On Hold)", title: "Lilygraphy — Photography Portfolio",
          ...
          thumb: "img/projects/lilygraphy-thumb.jpg",
          ...
          action: "Client brief, art direction, then an image-first static build — generous whitespace, restrained typography, fast loads — deployed to a Cloudflare Pages preview environment for review.",
    ...
    projects: {
      ...
      items: [
        { label: "مشروع لعميل (مباشر)", title: "حلويات فستق حلبي — موقع ثنائي اللغة",
          ...
          action: "دراسة مواقع المقاهي المحلية، ملف متطلبات منظّم مع الزبون، ثم البناء: موقع ثنائي اللغة بالكامل مع دعم RTL، بتقنية HTML/CSS/JS ثابتة منشورة على Cloudflare Pages، مع أداة مدمجة بسيطة يضيف بها صاحب المحل منتجاته ويحدّثها بنفسه دون نظام إدارة محتوى ثقيل. الطلب عبر واتساب بدل متجر إلكتروني — حيث يتواجد الزبائن أصلاً، مع صفحات قانونية متوافقة مع حماية البيانات الألمانية.",
        ...
        { label: "مشروع لعميل (متوقف مؤقتاً)", title: "Lilygraphy — بورتفوليو تصوير فوتوغرافي",
          ...
          action: "ملف متطلبات، توجيه فني، ثم بناء ثابت تتصدّره الصور: مساحات بيضاء واسعة، خطوط هادئة، تحميل سريع — نُشر على بيئة معاينة (Cloudflare Pages) للمراجعة والاعتماد.",
    ...
    projects: {
      ...
      items: [
        { label: "Kundenprojekt (Live)", title: "Aleppo Pistazien — zweisprachige Café-Website",
          ...
          action: "Benchmarking lokaler Café-Seiten, strukturiertes Kunden-Briefing, dann der Build: vollständig zweisprachig DE/AR inklusive RTL, statisches HTML/CSS/JS auf Cloudflare Pages — mit integriertem, leichtgewichtigem Produkt-Tool, über das der Ladenbetreiber das Sortiment selbst einpflegt und aktualisiert, ganz ohne schwergewichtiges CMS. Bestellungen laufen bewusst über WhatsApp statt Webshop — dort, wo die Kundschaft ohnehin ist. Impressum, Datenschutz, Allergen-Hinweise, Click-to-Load-Karte: DSGVO-sauber.",
        ...
        { label: "Kundenprojekt (pausiert)", title: "Lilygraphy — Fotografie-Portfolio",
          ...
          action: "Kunden-Briefing, Art Direction, dann ein bildzentrierter statischer Build — viel Weißraum, zurückhaltende Typografie, schnelle Ladezeiten — zur Abnahme auf einer Cloudflare-Pages-Preview deployed.",
