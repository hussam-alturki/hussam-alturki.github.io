/* ============================================================
   FULL-PAGE TRANSLATIONS — EN / AR / DE
   Ledger layout: content keys plus structural micro-labels
   (meta.*, services.exampleLabel) and the print business card.
   ============================================================ */
const translations = {
  en: {
    nav: {
      about: "About", experience: "Experience", services: "How I work",
      skills: "Skills", projects: "Selected Work", contact: "Contact"
    },
    meta: {
      locationLabel: "Location", location: "Augsburg, DE",
      langsLabel: "Languages", langs: "AR · DE · EN",
      statusLabel: "Status", status: "Open to remote roles"
    },
    hero: {
      name: "Hussam Alturki",
    ...
    experience: {
      title: "Experience",
      items: [
        { period: "09.2023 – Present", role: "Customer Support Specialist", company: "Concentrix · Meta Platforms",
        ...
        { period: "03.2023 – 08.2023", role: "Field Sales Partner", company: "Vodafone",
        ...
        { period: "10.2022 – 03.2023", role: "Receptionist", company: "Select Hotel Augsburg",
        ...
        { period: "08.2021 – 06.2023", role: "IT Support (Freelance)", company: "Self-employed",
        ...
        { period: "02.2020 – 09.2022", role: "Event Manager", company: "Xclusive Events",
    ...
    projects: {
      title: "Selected Work",
      disclaimer: "A mix of shipped client work and real internal workflows — labeled honestly, including the one currently on hold.",
      problemLabel: "Problem", actionLabel: "Action", resultLabel: "Result", viewLive: "View Live Project →",
      items: [
        { label: "Client Project (Live)", title: "Aleppo Pistazien — Bilingual Café Website",
          url: "https://aleppo-pistazien.de",
          thumb: "img/projects/aleppo-thumb.webp",
          thumbAlt: "aleppo-pistazien.de homepage in German and Arabic",
          problem: "A Syrian confectionery in Augsburg serving two language communities — German and Arabic — with no web presence of its own. The same questions arrived daily: hours, assortment, catering, halal.",
          action: "Benchmarked local café sites, wrote a structured client brief, then built a fully bilingual DE/AR site — every element mirrored, RTL included — as a static site on Cloudflare Pages with Decap CMS integrated, so the shop manager adds and updates the assortment themselves — content lives in the repo, no database to run. Ordering deliberately runs through WhatsApp instead of a webshop, because that's where the customers already are. Legal pages, allergen disclosure, and a click-to-load map keep it DSGVO-clean.",
          result: "Live at aleppo-pistazien.de: assortment, gallery, custom cakes, structured catering requests, FAQ — and the café's 4.8-star Google reputation, findable in both of its customers' languages. Built solo, AI-assisted, from brief to deployment." },
        { label: "Educational Game (Live)", title: "Escape from Berlin",
          url: "https://hussam-alturki.github.io/escape-from-berlin/",
          thumb: "img/projects/escape-thumb.webp",
          thumbAlt: "Escape from Berlin key art — bilingual quiz interface over the Berlin skyline",
        ...
        { label: "Support Ops (Real)", title: "Template System & KPI Automation",
          thumb: "img/projects/kpi-thumb.webp",
        ...
        { label: "Client Project (On Hold)", title: "Lilygraphy — Photography Portfolio",
          url: "https://lilygraphy.pages.dev/",
          thumb: "img/projects/lilygraphy-thumb.webp",
          thumbAlt: "Lilygraphy homepage — hand-painted flamingo shirt hero",
          problem: "A photographer's portfolio has one job: get out of the way. Most template sites bury the images under effects, sliders, and branding noise.",
          action: "Client brief, art direction, then an image-first build with Sanity Studio as the content backend, so galleries and images are managed without a developer. Generous whitespace, restrained typography, fast loads — deployed to a Cloudflare Pages preview environment for review.",
          result: "The site runs on its preview URL; the domain launch is currently on hold. It stays in my portfolio deliberately — real client work includes projects that pause, and the design decisions hold up either way." },
        { label: "Housing Module (Live)", title: "Housing Survival",
          ...
          thumb: "img/projects/housing-thumb.webp",
          thumbAlt: "Wohnungsnot — A2 Survival key art with German rental documents",
  ...
  ar: {
    ...
    meta: {
      locationLabel: "الموقع", location: "أوغسبورغ، ألمانيا",
      langsLabel: "اللغات", langs: "AR · DE · EN",
      statusLabel: "الحالة", status: "متاح للعمل عن بعد"
    },
    hero: {
      name: "حسام التركي",
    ...
    experience: {
      ...
      items: [
        { period: "09.2023 – الآن", role: "أخصائي دعم العملاء", company: "Concentrix · Meta Platforms",
        ...
        { period: "03.2023 – 08.2023", role: "شريك مبيعات ميدانية", company: "Vodafone",
        ...
        { period: "10.2022 – 03.2023", role: "موظف استقبال", company: "Select Hotel Augsburg",
        ...
        { period: "08.2021 – 06.2023", role: "دعم تقني (مستقل)", company: "عمل حر",
          points: "دعم الأجهزة والبرامج. توزيع الأجهزة. إدارة مستقلة للعملاء.",
          insight: "تعلمت: الأجهزة بجودة التوثيق المحيط بها فقط." },
        { period: "02.2020 – 09.2022", role: "منظم فعاليات", company: "Xclusive Events",
    ...
    projects: {
      title: "أعمال مختارة",
      disclaimer: "مزيج من أعمال حقيقية لعملاء وسير عمل داخلي فعلي — بتسميات صادقة، بما فيها المشروع المتوقف مؤقتاً.",
      problemLabel: "المشكلة", actionLabel: "الإجراء", resultLabel: "النتيجة", viewLive: "عرض المشروع المباشر ←",
      items: [
        { label: "مشروع لعميل (مباشر)", title: "حلويات فستق حلبي — موقع ثنائي اللغة",
          url: "https://aleppo-pistazien.de",
          thumb: "img/projects/aleppo-thumb.webp",
          thumbAlt: "الصفحة الرئيسية لموقع aleppo-pistazien.de بالعربية والألمانية",
          problem: "محل حلويات سوري في أوغسبورغ يخدم جمهورَين — عربياً وألمانياً — بلا موقع خاص به. أوقات الدوام، التشكيلة، الكاترينغ، الحلال: الأسئلة نفسها كل يوم.",
          action: "دراسة مواقع المقاهي المحلية، ملف متطلبات منظّم مع الزبون، ثم البناء: موقع ثنائي اللغة بالكامل مع دعم RTL، كموقع ثابت على Cloudflare Pages مع نظام Decap CMS مدمجاً، يضيف به صاحب المحل منتجاته ويحدّثها بنفسه — المحتوى محفوظ في المستودع دون قاعدة بيانات. الطلب عبر واتساب بدل متجر إلكتروني — حيث يتواجد الزبائن أصلاً، مع صفحات قانونية متوافقة مع حماية البيانات الألمانية.",
          result: "الموقع مباشر على aleppo-pistazien.de: التشكيلة، المعرض، الكاتو، نموذج الكاترينغ، الأسئلة الشائعة — وتقييم 4.8 نجوم على جوجل، بلغتَي الزبائن. تنفيذ فردي بمساعدة الذكاء الاصطناعي، من ملف المتطلبات حتى الإطلاق." },
        { label: "لعبة تعليمية (مباشرة)", title: "الهروب من برلين",
          url: "https://hussam-alturki.github.io/escape-from-berlin/",
          thumb: "img/projects/escape-thumb.webp",
          thumbAlt: "ملصق لعبة الهروب من برلين — واجهة اختبار ثنائية اللغة فوق أفق برلين",
        ...
        { label: "مشروع لعميل (متوقف مؤقتاً)", title: "Lilygraphy — بورتفوليو تصوير فوتوغرافي",
          url: "https://lilygraphy.pages.dev/",
          thumb: "img/projects/lilygraphy-thumb.webp",
          thumbAlt: "الصفحة الرئيسية لموقع Lilygraphy — قميص فلامينغو مرسوم يدوياً",
          problem: "بورتفوليو المصوّر مهمته أن يبتعد عن الطريق — معظم القوالب الجاهزة تدفن الصور تحت المؤثرات والضجيج البصري.",
          action: "ملف متطلبات، توجيه فني، ثم بناء تتصدّره الصور مع Sanity Studio كواجهة لإدارة المحتوى — تُدار المعارض والصور من خلاله دون مطوّر. مساحات بيضاء واسعة، خطوط هادئة، تحميل سريع — نُشر على بيئة معاينة (Cloudflare Pages) للمراجعة والاعتماد.",
          result: "الموقع يعمل على رابط المعاينة؛ إطلاق النطاق متوقف مؤقتاً. يبقى في أعمالي عن قصد — العمل الحقيقي مع العملاء يتضمن مشاريع تتوقف، وقرارات التصميم صامدة في الحالتين." },
        { label: "وحدة السكن (مباشرة)", title: "البقاء في سوق السكن",
          url: "https://hussam-alturki.github.io/escape-from-berlin/housing_survival.html",
          thumb: "img/projects/housing-thumb.webp",
          thumbAlt: "ملصق Wohnungsnot — مستندات الإيجار الألمانية في مشهد ليلي",
  ...
  de: {
    nav: {
      about: "Über mich", experience: "Berufserfahrung", services: "Arbeitsweise",
      skills: "Fähigkeiten", projects: "Arbeiten", contact: "Kontakt"
    },
    meta: {
      locationLabel: "Standort", location: "Augsburg, DE",
      langsLabel: "Sprachen", langs: "AR · DE · EN",
      statusLabel: "Status", status: "Offen für Remote-Stellen"
    },
    hero: {
      name: "Hussam Alturki",
    ...
    experience: {
      ...
      items: [
        { period: "09.2023 – Aktuell", role: "Customer Support Specialist", company: "Concentrix · Meta Platforms",
        ...
        { period: "10.2022 – 03.2023", role: "Rezeptionist", company: "Select Hotel Augsburg",
        ...
        { period: "08.2021 – 06.2023", role: "IT-Support (Freelance)", company: "Selbstständig",
    ...
    projects: {
      ...
      disclaimer: "Eine Mischung aus ausgelieferter Kundenarbeit und echten internen Workflows — ehrlich gelabelt, inklusive des Projekts, das gerade pausiert.",
      problemLabel: "Problem", actionLabel: "Vorgehen", resultLabel: "Ergebnis", viewLive: "Live-Projekt ansehen →",
      items: [
        { label: "Kundenprojekt (Live)", title: "Aleppo Pistazien — zweisprachige Café-Website",
          url: "https://aleppo-pistazien.de",
          thumb: "img/projects/aleppo-thumb.webp",
          thumbAlt: "Startseite von aleppo-pistazien.de auf Deutsch und Arabisch",
          problem: "Eine syrische Konditorei in Augsburg, zwei Sprachgemeinschaften — und keine eigene Web-Präsenz. Öffnungszeiten, Sortiment, Catering, Halal: dieselben Fragen, jeden Tag.",
          action: "Benchmarking lokaler Café-Seiten, strukturiertes Kunden-Briefing, dann der Build: vollständig zweisprachig DE/AR inklusive RTL, als statische Seite auf Cloudflare Pages mit integriertem Decap CMS, über das der Ladenbetreiber das Sortiment selbst einpflegt und aktualisiert — die Inhalte liegen im Repo, keine Datenbank nötig. Bestellungen laufen bewusst über WhatsApp statt Webshop — dort, wo die Kundschaft ohnehin ist. Impressum, Datenschutz, Allergen-Hinweise, Click-to-Load-Karte: DSGVO-sauber.",
          result: "Live auf aleppo-pistazien.de: Sortiment, Galerie, Torten, Catering-Anfragen per Formular, FAQ — und die 4,8-Sterne-Google-Reputation des Cafés, auffindbar in beiden Sprachen seiner Kundschaft. Solo umgesetzt, AI-gestützt, vom Briefing bis zum Deployment." },
        { label: "Lernspiel (Live)", title: "Escape from Berlin",
          url: "https://hussam-alturki.github.io/escape-from-berlin/",
          thumb: "img/projects/escape-thumb.webp",
          thumbAlt: "Escape-from-Berlin-Key-Art — zweisprachige Quiz-Oberfläche über der Berliner Skyline",
        ...
        { label: "Kundenprojekt (pausiert)", title: "Lilygraphy — Fotografie-Portfolio",
          url: "https://lilygraphy.pages.dev/",
          thumb: "img/projects/lilygraphy-thumb.webp",
          thumbAlt: "Lilygraphy-Startseite — handbemaltes Flamingo-Shirt",
          problem: "Ein Fotografie-Portfolio hat genau eine Aufgabe: aus dem Weg gehen. Die meisten Template-Seiten begraben die Bilder unter Effekten, Slidern und Branding-Lärm.",
          action: "Kunden-Briefing, Art Direction, dann ein bildzentrierter Build mit Sanity Studio als Content-Backend — Galerien und Bilder lassen sich dort ohne Entwickler pflegen. Viel Weißraum, zurückhaltende Typografie, schnelle Ladezeiten; zur Abnahme auf einer Cloudflare-Pages-Preview deployed.",
          result: "Die Seite läuft auf ihrer Preview-URL; der Domain-Launch liegt derzeit auf Eis. Sie bleibt bewusst im Portfolio — echte Kundenarbeit enthält auch Projekte, die pausieren. Die Design-Entscheidungen tragen trotzdem." },
        { label: "Wohnungsmodul (Live)", title: "Housing Survival",
          url: "https://hussam-alturki.github.io/escape-from-berlin/housing_survival.html",
          thumb: "img/projects/housing-thumb.webp",
          thumbAlt: "Wohnungsnot — A2-Survival-Key-Art mit deutschen Mietdokumenten",
