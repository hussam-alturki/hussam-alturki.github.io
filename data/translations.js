    ...
    projects: {
      ...
      items: [
        { label: "Client Project (Live)", title: "Aleppo Pistazien — Bilingual Café Website",
          ...
          action: "Benchmarked local café sites, wrote a structured client brief, then built a fully bilingual DE/AR site — every element mirrored, RTL included — as static HTML/CSS/JS with no CMS to maintain, deployed on Cloudflare Pages. Ordering deliberately runs through WhatsApp instead of a webshop, because that's where the customers already are. Legal pages, allergen disclosure, and a click-to-load map keep it DSGVO-clean.",
    ...
    projects: {
      ...
      items: [
        { label: "مشروع لعميل (مباشر)", title: "حلويات فستق حلبي — موقع ثنائي اللغة",
          ...
          action: "دراسة مواقع المقاهي المحلية، ملف متطلبات منظّم مع الزبون، ثم البناء: موقع ثنائي اللغة بالكامل مع دعم RTL، بتقنية HTML/CSS/JS ثابتة بلا نظام إدارة محتوى، منشور على Cloudflare Pages. الطلب عبر واتساب بدل متجر إلكتروني — حيث يتواجد الزبائن أصلاً، مع صفحات قانونية متوافقة مع حماية البيانات الألمانية.",
    ...
    projects: {
      ...
      items: [
        { label: "Kundenprojekt (Live)", title: "Aleppo Pistazien — zweisprachige Café-Website",
          ...
          action: "Benchmarking lokaler Café-Seiten, strukturiertes Kunden-Briefing, dann der Build: vollständig zweisprachig DE/AR inklusive RTL, statisches HTML/CSS/JS ohne pflegebedürftiges CMS, deployed auf Cloudflare Pages. Bestellungen laufen bewusst über WhatsApp statt Webshop — dort, wo die Kundschaft ohnehin ist. Impressum, Datenschutz, Allergen-Hinweise, Click-to-Load-Karte: DSGVO-sauber.",
