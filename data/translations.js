  ...
  ar: {
    ...
    projects: {
      ...
      items: [
        ...
        { label: "لعبة تعليمية — وحدة السكن (مباشرة)", title: "الهروب من برلين — المستوى 2", url: "https://huss4am7.github.io/escape-from-berlin/housing_survival.html",
          problem: "يواجه الوافدون الجدد الناطقون بالعربية إلى ألمانيا منحنى تعليمي حاد في التنقل بسوق الإيجار — Schufa، عقد الإيجار، Selbstauskunft، توقعات المالك. الموارد الموجودة ثقيلة نصياً وسلبية؛ يحتاج المتعلمون إلى ممارسة اتخاذ القرارات تحت ضغط واقعي.",
